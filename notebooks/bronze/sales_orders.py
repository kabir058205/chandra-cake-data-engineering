...
raw_url = "https://raw.githubusercontent.com/kabir058205/chandra-cake-data-engineering/main/data/sales_orders.csv"
...
bronze_path = "/Volumes/workspace/bronze/sales_orders/sales_orders.csv"
...
spark_df.write.mode("append").format("delta").option("mergeSchema", "true").saveAsTable("bronze.sales_orders")
print(f"Data from {bronze_path} loaded to bronze.sales_orders table.")
